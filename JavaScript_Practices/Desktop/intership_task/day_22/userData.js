...
// export {usersData as data}
// export {usersData}  // we can export the value only once times in export defult. A module cannot have multiple default exports.
export const myname = "shubham";
export let passed = true

export default function firrsttenuser(){
  let arr=[]
  for(let i=0;i<=10;i++){
    arr.push(usersData[i].firstName)
  }
  return arr
}
